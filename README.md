...
I'm also a Ruby, Rails, and automation consultant with 24 years of web development experience. I’ve helped teams and companies save 3 to 7 work-months per year by automating manual tasks, speeding up daily workflows and test suites, improving developer happiness, code quality and maintainability, and eliminating or shortening meetings. I spent several years in Civic Tech at [Code for America](https://github.com/codeforamerica), [18F](https://github.com/18F) and [Truss](https://github.com/TrussWorks), where I worked on open source Rails projects that serve millions of people, such as login.gov. Fun fact: It's been over 6 years since I stopped contributing to the login.gov codebase, yet I remain in the [top 5 contributors](https://github.com/18F/identity-idp/graphs/contributors).
